...
<body>
    ...
    <div class="container my-5">
        ...
        <h6 style="font-size: 190px;"><i class="bi bi-image"></i></h6>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Modals are better with Bootstrap. In fact, everything is.</p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                        <button type="button" class="btn btn-primary">Agree and Close</button>
                    </div>
                </div>
            </div>
        </div>
